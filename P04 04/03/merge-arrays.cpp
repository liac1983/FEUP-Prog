...
int* merge_arrays(const int a[], int na, const int b[], int nb) {
    int* c = new int[na + nb]; // Aloca espaço para o array resultante
...
int main() {
    ...
    int* c1 = merge_arrays(a1, NA1, b1, NB1);
    ...
    int b2[NB2] = { 1, 2, 4, 7 };
    int* c2 = merge_arrays(a2, NA2, b2, NB2);
    ...
    int a3[NA3] = { 0, 1 };
    int b3[NB3] = { 2, 3, 4 };
    int* c3 = merge_arrays(a3, NA3, b3, NB3);
    ...
    int a4[NA4] = { 2, 3, 4 };
    int b4[NB4] = { 0, 1 };
    int* c4 = merge_arrays(a4, NA4, b4, NB4);
    ...
    int* c5 = merge_arrays(a5, NA5, b5, NB5);
